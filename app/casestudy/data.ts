...
import ASHOK_BUILDERS_RESIDENTIAL_COMMERCIAL from "./casestudyimages/CONSTRUCTIONS/ASHOK BUILDERS RESIDENTIAL&COMMERCIAL.png";
...
/* =========================
   IT
========================= */
import ADD_A_SUBHEADING_500_X_500_PX from "./casestudyimages/IT/Add a subheading (500 x 500 px).png";
...
import NELLORE_MUNCIPAL from "./casestudyimages/MUNCIPALITY/NELLORE MUNCIPAL.png";
...
export const CASE_STUDIES_BY_SECTOR: Record<string, CaseStudy[]> = {
  ...
  Government: [
    ...
    },
    {
      ...
      avatar: MLC_ELECTIONS,
      rating: 5,
      quote: "Deployed 4G-based video surveillance across 12 districts and 1,450 polling stations to boost efficiency, transparency, and security.",
      challenges: [
      ...
      slug: "mlc-elections-monitoring",
      sector: "Government",
      sectorSlug: "government",
      project_objective:"The 2023 MLC Elections in Andhra Pradesh and Telangana focused on boosting efficiency, transparency, and security with improved connectivity and monitoring. A strong network was deployed across 12 districts to enable seamless communication at 1,450 polling stations.",
    },
    {
      id: 32,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
  ...
  Religious: [
    ...
    },
    {
      ...
      avatar: KONDAGATTU_ANJANEYASWAMY_TEMPLE,
      rating: 5,
      quote: "Established a CCTV surveillance system to support local authorities in maintaining security and managing crowds at the historic temple.",
      challenges: [
      ...
      slug: "kondagattu-anjaneya-swamy-temple-2",
      sector: "Religious",
      sectorSlug: "religious",
       project_objective:"The main goal of the project was to set up a reliable CCTV surveillance system at the Kondagattu Anjaneya Swamy Temple in Mallial Mandal, Jagtial District, Telangana. The system was intended to support local authorities in maintaining security.",
    },
