...
const page1Data: PageOneProfile = {
  ...
  summary:
    "Visionary technology entrepreneur with 15+ years in IT, AI-driven security, smart governance, and digital transformation. Leads large-scale AI & IoT programs for government, banking, and enterprise.",
  experience: [
    {
        ...
        >
          ...
          >
            ...
            >
              ...
              enterprises through the intelligence of AI and IoT.”
            </p>
          </blockquote>
        </motion.div>
